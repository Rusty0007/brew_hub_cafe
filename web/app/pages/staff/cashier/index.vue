...
<template>
  ...
  >
    ...
    >
      Handle BrewHub customer orders,
    ...
    <DashboardRoleDashboard role="cashier" />
    ...
    >
      ...
      >
        <p
          class="text-xs font-semibold uppercase tracking-[0.15em] text-brew-400"
        >
          Point of Sale
        </p>

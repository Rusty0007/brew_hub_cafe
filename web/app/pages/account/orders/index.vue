...
const {
  ...
  error,
  refresh,
} = await useLazyFetch<OrdersResponse>(
  '/api/customer/orders',
)
  ...
  >
        ...
        >
          <div class="flex-1">
            ...
            >
              ...
              <AppSkeleton class="h-7 w-24 rounded-full" />
            </div>
          ...
          >
            <div>
              <AppSkeleton class="ml-auto h-3 w-12" />
              <AppSkeleton class="mt-2 h-6 w-24" />
            </div>
    ...
    <!-- ERROR -->
      <AppStatePanel
        ...
        message="
          BrewHub could not retrieve your
          order history. Please try again.
        "
      >
        <button
          type="button"
    ...
    <!-- EMPTY -->
      <AppStatePanel
        ...
        title="No orders yet"
        message="
          Your BrewHub orders will appear
